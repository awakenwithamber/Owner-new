...
(function() {
  ...
  var validSections = ['home','shop','herbal-wisdom','herbal-library','custom-formula','herb-index','journal','soaps','services','about','faqs','contact','checkout','bundles','grimoire-membership'];
